...
if __name__ == '__main__':
    ...
    Regarding this, we add all the sections for the biotypes coming from PubTator to the pathwaysObjects.pl file. And we generated
    new reports for then, named: ligands.pl, genes.pl, diseases.pl, variants.pl, species.pl, and cell_lines.pl.
    """
    ...
    with open(pathways_objects_path, 'w', encoding="utf8") as path_objects:
        ...
        path_objects.write("% cell lines from PubTator" + "\n" + "\n")
