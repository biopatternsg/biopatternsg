...
inicio(A,E,B):-base(C),buscar_en_lista(event(A,E,B),C),buscar_en_lista(E,[bind,association]),(ligand(A);receptor(A)),receptor(B),not(A = B).

%inicio(A,E,B):-base(C),buscar_en_lista(event(A,E,B),C),buscar_en_lista(E,[bind,association]),receptor(A),receptor(B),(A = B).

%evento final patron tipo 1, tipo 2  transcription_factor -> objeto_de_cierre
final(A,E,B):-base(C),buscar_en_lista(event(A,E,B),C),(transcription_factor(A);receptor(A)),buscar_en_lista(E,[negative_correlation,inhibition,positive_correlation,bind]).
...
inicio_rest(A,E,B,L):-buscar_en_lista(A,L),buscar_en_lista(B,L),base(C),buscar_en_lista(event(A,E,B),C),buscar_en_lista(E,[bind,association]),(ligand(A);receptor(A)),receptor(B),not(A = B).

%inicio_rest(A,E,B,L):-buscar_en_lista(A,L),buscar_en_lista(B,L),base(C),buscar_en_lista(event(A,E,B),C),buscar_en_lista(E,[bind,association]),receptor(A),receptor(B),(A = B).

final_rest(A,E,B,L):-buscar_en_lista(A,L),buscar_en_lista(B,L),base(C),buscar_en_lista(event(A,E,B),C),(transcription_factor(A);receptor(A)),buscar_en_lista(E,[negative_correlation,inhibition,positive_correlation,bind]).
